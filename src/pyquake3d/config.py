...
def readPara(data_dir):
    ...
    try:
        Para['Regularized fault zone']=float(Para0['Regularized fault zone'])
        Para['InputRFZ']=Para0['InputRFZ']=='True'
        Para['InputRFZ file']=Para0['InputRFZ file']
    except:
        pass
    ...
    try:
        Para['viscosity']=float(Para0['viscosity'])
        #Para['viscosity2']=float(Para0['viscosity2'])

    except:
        print('No viscosity parameters.')
